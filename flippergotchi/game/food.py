...
hunger; rarer kinds restore more (and carry a scrap salvage value for a later
phase). ``mechanics.snack`` takes an optional ``kind`` -- with none it falls back
...
class FoodKind:
    ...
    salvage: int = 0      # scrap value if salvaged instead (wired in a later phase)
...
CATALOG: list[FoodKind] = [
    ...
    FoodKind("squid", "Circuit Squid", 22, "uncommon", salvage=8),
    FoodKind("roe", "Neon Roe", 34, "rare", salvage=22),
    FoodKind("cell", "Power Cell", 45, "rare", salvage=35),
]
